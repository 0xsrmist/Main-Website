...
const Hero = () => {
	return (
		<section className='w-full min-h-screen relative bg-[url(/assets/images/circles.svg)] z-20 bg-no-repeat bg-center bg-cover place-items-center grid grid-cols-1 md:grid-cols-2 gap-8 mt-20 md:mt-12'>
